                    ...
                    >
                      ...
                      <div className="relative z-10">
                        ...
                        <div className="flex items-end justify-between mb-2">
                          ...
                          <span
                            className={`text-sm font-bold ${s.trendUp ? (isDarkMode ? 'text-teal-400' : 'text-teal-600') : 'text-red-500'}`}
                          >
                            {s.change}
                          </span>
                        </div>
                        <div className="flex items-center gap-2">
                          ...
                          <span
                            className={`text-sm font-medium ${s.trendUp ? (isDarkMode ? 'text-teal-400' : 'text-teal-600') : 'text-red-600'}`}
                          >
                            {s.trend}
                          </span>
                        </div>
